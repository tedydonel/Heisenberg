...
class HeisenbergMailableTest extends TestCase
{
    ...
    // mailable never substitutes values; the host's newsletter integration
    // reads the rendered text and substitutes at send time.
    // ====================================================================
    ...
    public function test_variable_placeholders_are_passed_through_verbatim(): void
    {
        ...
        $this->assertSame('Welcome {{ user.first_name }}', $mailable->result->subject);
        $mailable->assertSeeInHtml('Hi {{ user.first_name }}');
