...
{
    /** The 20 documented block types, in blueprint order (§2.2). */
    private const ALL = [
    ...
    public function test_has_the_twenty_documented_cases_with_exact_values(): void
    {
        $this->assertCount(20, BlockType::cases());
        $this->assertSame(
            self::ALL,
