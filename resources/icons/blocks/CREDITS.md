...
Icons imported into Heisenberg (`resources/icons/blocks/`) from the VvvebJs icon collection (`resources/svg/icons/<set>/index.html`) on 2026-08-08.

Each set directory carries its own `LICENSE`/`NOTICE` file copied verbatim from the source when one was present. Attribution above is required for the CC-BY licensed sets (150 Free Outlined Icons, 77 Essential Icons, Dripicons, Linea, Core UI, Font Awesome, Olicons).

Total icons imported: 29452 across 30 sets.
