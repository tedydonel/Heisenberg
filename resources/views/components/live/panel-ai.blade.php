...
<div data-hb-panel-ai
    ...
    data-msg-translated-into="{{ __('heisenberg::editor.panel_ai_tools.ai_translated_into') }}"
    data-msg-translated-title-into="{{ __('heisenberg::editor.panel_ai_tools.ai_translated_title_into') }}"
    data-msg-translated-toc-into="{{ __('heisenberg::editor.panel_ai_tools.ai_translated_toc_into') }}"
    data-msg-translate-home="{{ __('heisenberg::editor.panel_ai_tools.ai_translate_home') }}"
