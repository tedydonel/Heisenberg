<script nonce="{{ heisenberg_csp_nonce() }}">
    (() => {
        ...
        // Pure text helpers live in panel-text-script.blade.php (split out to keep this view
        // under the Livewire morph-compile ceiling, BladeFileSizeGuardTest).
        const { renderMarkdown, splitReasoning, extractMarkup, proseOf } = window.hbAiText;
