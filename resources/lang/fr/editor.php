...
return [
    ...
    'code' => [
        ...
        'err_md_list' => 'Le texte de [:slug] contient une liste markdown (« :sample ») — le markdown ne s\'affiche pas, il apparaît tel quel sur la page. Utilisez plutôt un bloc [list] : un élément par ligne, sans « - », « * » ni numéro en tête (ordered=true pour une liste numérotée).',
        'err_md_heading' => 'Le texte de [:slug] a une ligne commençant par « # » (« :sample ») — le markdown ne s\'affiche pas. Utilisez plutôt un bloc de titre, par ex. [h2]…[/h2].',
        'err_md_emphasis' => 'Le texte de [:slug] utilise du **gras** markdown (« :sample ») — il ne s\'affiche pas. Utilisez du HTML en ligne : <strong>…</strong> et <em>…</em>.',
        'err_md_fence' => 'Le texte de [:slug] contient une clôture de code ``` — elle ne s\'affiche pas. Utilisez du texte simple ici, ou un bloc de code.',
    ...
    'panel_ai_tools' => [
        ...
        'ai_building_one' => 'Construction de la page — :count bloc…',
        'ai_built' => ':count blocs construits sur la page.',
        'ai_built_one' => ':count bloc construit sur la page.',
