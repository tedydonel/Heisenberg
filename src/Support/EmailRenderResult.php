...
/**
 * The output of {@see EmailRenderer::render()} (docs/email-system.md §5) —
 ...
 * manifest {@see HeisenbergMailable} attaches from.
 *
 ...
 * directly"); {@see HeisenbergMailable} is the bundled convenience wrapper for
 * `Mail::to(...)->send(...)`.
 */
