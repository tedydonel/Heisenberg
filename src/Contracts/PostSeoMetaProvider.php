 ...
 * backing model now exists — {@see SeoMeta}, the polymorphic `seo_meta`
 * table (docs/BLUEPRINT.md §2.3.11/§2.4) — and {@see NativeSeoMetaProvider}
 ...
 * {@see NullPostSeoMetaProvider} at that key to opt out entirely (always
...
interface PostSeoMetaProvider
{
     ...
     * `ogDescription`, and `jsonLd` (schema.org JSON-LD, {@see SeoMeta::getJsonLd()})
